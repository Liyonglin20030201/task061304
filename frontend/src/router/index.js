...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'data-quality', name: 'DataQuality', component: () => import('../views/DataQuality.vue') },
      { path: 'employee-performance', name: 'EmployeePerformance', component: () => import('../views/EmployeePerformance.vue') },
      { path: 'product-lifecycle', name: 'ProductLifecycle', component: () => import('../views/ProductLifecycle.vue') },
      { path: 'demand-forecast', name: 'DemandForecast', component: () => import('../views/DemandForecast.vue') },
